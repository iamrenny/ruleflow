...
expr: L_PAREN expr R_PAREN                                                      #parenthesis
    ...
    | value=propertyTuple not=K_NOT? op=(K_CONTAINS | K_IN | K_STARTS_WITH) values=listElems #multiValueslist
...
listElems: storedList=K_LIST L_PAREN string_literal R_PAREN
         ...
         | literalMultiList= L_PAREN L_PAREN string_literal (COMMA string_literal)* R_PAREN( COMMA L_PAREN string_literal (COMMA string_literal)* R_PAREN)* R_PAREN
         | validProperty;
