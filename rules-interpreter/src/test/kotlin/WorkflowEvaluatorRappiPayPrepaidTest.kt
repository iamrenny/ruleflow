        ...
        fun rules(): Array<Arguments> {
            return arrayOf(
                ...
                Arguments.of(
                    ...
                    WorkflowResult("Rappi Pay Prepaid", "vector_rule_hard_cap", "amt_1d", "block")
                ),
                Arguments.of(
                    "samples/data/prepaid_hard_cap_amt_7d.json",
                    WorkflowResult("Rappi Pay Prepaid", "vector_rule_hard_cap", "amt_7d", "block")
                ),
                Arguments.of(
                    "samples/data/prepaid_hard_cap_amt_transaction.json",
                    WorkflowResult("Rappi Pay Prepaid", "vector_rule_hard_cap", "amt_transaction", "block")
                ),
                Arguments.of(
                    "samples/data/prepaid_hard_cap_qty_1d.json",
                    WorkflowResult("Rappi Pay Prepaid", "vector_rule_hard_cap", "qty_1d", "block")
                ),
                Arguments.of(
                    "samples/data/prepaid_hard_cap_qty_6h.json",
                    WorkflowResult("Rappi Pay Prepaid", "vector_rule_hard_cap", "qty_6h", "block")
                ),

                // Card not present
                Arguments.of(
                    "samples/data/prepaid_card_not_present_amt_transaction.json",
                    WorkflowResult("Rappi Pay Prepaid", "card_not_present_hard_cap", "amt_transaction", "block")
                ),
                Arguments.of(
                    "samples/data/prepaid_card_not_present_qty_1d.json",
                    WorkflowResult("Rappi Pay Prepaid", "card_not_present_hard_cap", "qty_1d", "block")
                ),
                Arguments.of(
                    "samples/data/prepaid_card_not_present_qty_6h.json",
                    WorkflowResult("Rappi Pay Prepaid", "card_not_present_hard_cap", "qty_6h", "block")
                ),
                Arguments.of(
                    "samples/data/prepaid_card_not_present_amt_1d.json",
                    WorkflowResult("Rappi Pay Prepaid", "card_not_present_hard_cap", "amt_1d", "block")
                ),

                // Hard Cap International
                Arguments.of(
                    "samples/data/prepaid_hard_cap_int_amt_1d.json",
                    WorkflowResult("Rappi Pay Prepaid", "vector_rule_hard_cap_international", "amt_1d", "block")
                ),
                Arguments.of(
                    "samples/data/prepaid_hard_cap_int_amt_7d.json",
                    WorkflowResult("Rappi Pay Prepaid", "vector_rule_hard_cap_international", "amt_7d", "block")
                ),
                Arguments.of(
                ...
                Arguments.of(
                    ...
                    WorkflowResult("Rappi Pay Prepaid", "vector_rule_hard_cap_international", "qty_1d", "block")
                ),
                Arguments.of(
                    "samples/data/prepaid_hard_cap_int_qty_6h.json",
                    WorkflowResult("Rappi Pay Prepaid", "vector_rule_hard_cap_international", "qty_6h", "block")
                ),

                // Velocity
                Arguments.of(
                    "samples/data/prepaid_velocity.json",
                    WorkflowResult("Rappi Pay Prepaid", "vector_rule", "velocity", "block")
                ),

                // High Rejected Ratio
                Arguments.of(
                    "samples/data/prepaid_high_rejected_ratio.json",
                    WorkflowResult("Rappi Pay Prepaid", "vector_rule", "high_rejected_ratio", "block")
                ),

                // Skimming Counterfeit Card
                Arguments.of(
                    "samples/data/prepaid_skimming_counterfeit_card.json",
                    WorkflowResult("Rappi Pay Prepaid", "skimming_counterfeit_card", "deny", "block")
                ),

                // Fraudulent funds
                Arguments.of(
                    "samples/data/prepaid_copied_card_cash_out_of_fraudulent_funds.json",
                    WorkflowResult("Rappi Pay Prepaid", "copied_card_cash_out_of_fraudulent_funds", "deny", "block")
                ),

                // Potentially copied card foreign withdraw
                Arguments.of(
                    "samples/data/prepaid_potentially_copied_card_foreign_withdraw.json",
                    WorkflowResult("Rappi Pay Prepaid", "potentially_copied_card_foreign_withdraw", "deny", "block")
                ),

                // Potentially copied card
                Arguments.of(
                    "samples/data/prepaid_potentially_copied_card.json",
                    WorkflowResult("Rappi Pay Prepaid", "potentially_copied_card", "deny", "block")
                ),

                // Decline attempts when above the set limit
                Arguments.of(
                    "samples/data/prepaid_decline_attempts_when_above_the_set_limit.json",
                    WorkflowResult("Rappi Pay Prepaid", "decline_attempts_when_above_the_set_limit", "deny", "block")
                ),

                // Decline attempts when above the set limit
                Arguments.of(
                    "samples/data/prepaid_high_risk_location_rule.json",
                    WorkflowResult("Rappi Pay Prepaid", "high_risk_location_rule", "deny", "block")
                ),
